...
RUN  wget -q https://mirrors.huaweicloud.com/openjdk/9/openjdk-9_linux-x64_bin.tar.gz && tar zxf openjdk-9_linux-x64_bin.tar.gz && rm openjdk-9_linux-x64_bin.tar.gz
RUN ls -l
